...
function c4() // tea room
{
  ...
  if (mouseX >= 750 && mouseX <= 780 && mouseY >= 100 && mouseY <= 490)
  {
    cursorimage = "hand";
    textSize(20);
    fill(0,0,0);
    image(ArtSgn,300,100,250,187);
    if (mouseIsPressed)
    {
      cursorimage = "arrow";
      canvas = 5;
